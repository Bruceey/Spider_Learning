...
if __name__ == '__main__':
    ...
    try:
        ...
        rili = r.get("rili") if r.get("rili") else ''
        dongman = r.get("dongman") if r.get("dongman") else ''
        fengjing = r.get("fengjing") if r.get("fengjing") else ''
        meinv = r.get("meinv") if r.get("meinv") else ''
        youxi = r.get("youxi") if r.get("youxi") else ''
        yingshi = r.get("yingshi") if r.get("yingshi") else ''
        dongtai = r.get("dongtai") if r.get("dongtai") else ''
        weimei = r.get("weimei") if r.get("weimei") else ''
        sheji = r.get("sheji") if r.get("sheji") else ''
        keai = r.get("keai") if r.get("keai") else ''
        qiche = r.get("qiche") if r.get("qiche") else ''
        huahui = r.get("huahui") if r.get("huahui") else ''
        dongwu = r.get("dongwu") if r.get("dongwu") else ''
        jieri = r.get("jieri") if r.get("jieri") else ''
        renwu = r.get("renwu") if r.get("renwu") else ''
        meishi = r.get("meishi") if r.get("meishi") else ''
        shuiguo = r.get("shuiguo") if r.get("shuiguo") else ''
        jianzhu = r.get("jianzhu") if r.get("jianzhu") else ''
        tiyu = r.get("tiyu") if r.get("tiyu") else ''
        junshi = r.get("junshi") if r.get("junshi") else ''
        feizhuliu = r.get("feizhuliu") if r.get("feizhuliu") else ''
        qita = r.get("qita") if r.get("qita") else ''
        wangzhe = r.get("wangzhe") if r.get("wangzhe") else ''
        huyan = r.get("huyan") if r.get("huyan") else ''
        lol = r.get("lol") if r.get("lol") else ''
